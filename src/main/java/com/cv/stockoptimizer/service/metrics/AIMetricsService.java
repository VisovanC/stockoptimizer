...
/**
 * Service for tracking and analyzing the performance of AI recommendations
 */
@Service
public class AIMetricsService {
    ...
    // Map to store recommendation performance (portfolioId -> metrics)
    ...
    /**
     * Track performance of all AI recommendations weekly
     */
    @Scheduled(cron = "0 0 5 * * 0") // 5 AM every Sunday
    public void trackRecommendationPerformance() {
        ...
        for (Map.Entry<String, RecommendationMetrics> entry : metricsMap.entrySet()) {
            ...
            try {
                ...
                // Clean up old records (older than 180 days)
    ...
    public Map<String, Object> getRecommendationPerformance(String portfolioId) {
        ...
        // Calculate expected returns from benchmarks for comparison
        try {
            // Use S&P 500 as benchmark (symbol: ^GSPC)
    ...
    /**
     * Calculate return of a benchmark index over a period
     */
    ...
    /**
     * Internal class to store metrics for a recommendation
     */
